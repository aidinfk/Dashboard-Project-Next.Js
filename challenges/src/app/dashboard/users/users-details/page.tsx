...
const UserDetails = () => {
    const user = {
        ...
        activities: [
            {id: 1, description: "Updated password", timestamp: "2025-08-30"},
            {id: 2, description: "Change email address", timestamp: "2025-06-12"},
            {id: 3, description: "Logged in from a new device", timestamp: "2025-02-01"},
        ]
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-xl p-8">
            <div className="flex items-center mb-8">
                ...
                <div>
                    ...
                    <p className={`text-sm mt-2 ${user.status === "Active" ? "text-green-500" : "text-red-500"}`}>Status: {user.status}
                    </p>
                </div>
            </div>
            {/* Bio Section */}
            ...
            <div className="mb-8">
                ...
                <ul className="space-y-4">{user.activities.map((activity) => (
